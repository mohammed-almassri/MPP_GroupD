...
public class Main {
	...
	public static void main(String[] args) {
		...
		List<String> list100E = LambdaLibrary.EMPLOYEES_AFTER.apply(list);
		System.out.println(list100E);
		...
		List<String> list85R = LambdaLibrary.EMPLOYEES_FULL.apply(list);
		System.out.println(list85R);
	}
